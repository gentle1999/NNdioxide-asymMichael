...
class BatchMolGraph:
    ...
    _mgs: Sequence[MolGraph] = field(init=False, repr=False)
    ...
    def clone(self) -> "BatchMolGraph":
        """Returns a copy of this :class:`BatchMolGraph`"""
        return BatchMolGraph(self._mgs)
